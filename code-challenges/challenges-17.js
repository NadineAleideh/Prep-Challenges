...
const recursionPattern = (int1, int2) => {
    ...
    const b = recursionPattern(int1 - int2, int2);
    return [int1].concat(b, b.length === 0 ? [] : [int1]);
...
const filterLinks = (str) => {
    // write your code here
    // Regular expression to extract the link
    var regex = /www\.+[A-Za-z]+\.(?:com|org|net)/;

    // Extract the link using the regular expression
