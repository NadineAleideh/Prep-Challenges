...
const objLat = (obj) => {
    ...
    const firstNameC = firstName.charAt(0).toUpperCase() + firstName.slice(1);
    const lastName = obj.lastName;
    const lastNameC = lastName.charAt(0).toUpperCase() + lastName.slice(1);

    return(`my name is ${firstNameC} ${lastNameC} I am ${obj.age} YO, and I love ${obj.hobby}.`);
};
// -------------------------------------------------------------------------------------------------------
